//custom version for visual studio
...
declare module "crypto" {
    ...
    export interface Cipher extends NodeJS.ReadWriteStream {
        ...
        update(data: string, input_encoding: any): Buffer;
        update(data: Buffer, input_encoding: any, output_encoding: any): string;
        update(data: string, input_encoding: any, output_encoding: any): string;
        final(): Buffer;
